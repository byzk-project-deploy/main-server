...
func Init() {
	...
	serverclientcommon.CmdPluginUninstall.Registry(pluginUninstallCmd)
	serverclientcommon.CmdPluginEnabled.Registry(pluginEnabledCmd)
	serverclientcommon.CmdPluginDisabled.Registry(pluginDisabledCmd)
